...
const Card = () => {
  ...
  return (
    <div className="mt-12 w-full rounded-t-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 shadow-xl">
      <div className="max-w-7xl lg:flex mx-auto px-6">
        {/* Left Text Content */}
        <div className="lg:w-[50%] lg:border-r lg:mr-8">
          <h3 className="lg:text-[3.5rem] text-3xl font-bold text-white mb-2">
            Let’s talk about
          </h3>
          <h3 className="lg:text-[3.5rem] text-3xl h-fit gap-5 flex font-bold text-white mb-2">
            your
            <RotatingText
              texts={[
                "Idea",
              ...
              mainClassName="px-6 bg-white text-black overflow-hidden lg:pt-0 pt-1 justify-center rounded-lg"
              staggerFrom="last"
              //@ts-ignore
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
          ...
          <p className="lg:mt-12 mt-6 text-white/80 lg:w-[90%] mb-4">
        ...
        <div className="flex lg:w-[50%] flex-col gap-3">
          ...
          <a
            ...
            className="text-white h-full flex items-center cursor-none justify-center border border-white/30 px-4 py-2 rounded-md hover:bg-white/10 transition"
          >
            Connect on LinkedIn
          </a>
        </div>
